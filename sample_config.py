...
class Config(object):
    ...
    # Get this value by running python3 stringsetup.py or https://replit.com/@lonylly/ADX#main.py/@TEAM_ADX/stringsession
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/lonylly/adx2.git"
    )
    ...
    ADX_START = os.environ.get("ADX_START", None)
    PMPERMIT_TEXT_ADX = os.environ.get("PMPERMIT_TEXT_ADX", None)
    UB_BLACK_LIST_CHAT = {
    ...
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/8b050eb221b43a100a403.jpg"
    )
